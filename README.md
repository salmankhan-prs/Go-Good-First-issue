...
## go-sprout/sprout <span style='color:#F1C40F'>(96 ⭐️)</span>

- [bug: Tests fail locally if local timezone != UTC](https://github.com/go-sprout/sprout/issues/81)

- [bug: toYaml should omit empty fields similar to toJson](https://github.com/go-sprout/sprout/issues/80)

- [bug: Not all documentation examples work](https://github.com/go-sprout/sprout/issues/78)


## celestiaorg/celestia-node <span style='color:#F1C40F'>(934 ⭐️)</span>
...
## spiffe/spike <span style='color:#F1C40F'>(30 ⭐️)</span>
...
## gdegiorgio/systatus <span style='color:#F1C40F'>(6 ⭐️)</span>

- [[FEATURE] Write E2E tests](https://github.com/gdegiorgio/systatus/issues/37)

- [[FEATURE] Improve logging throughout handlers](https://github.com/gdegiorgio/systatus/issues/28)

- [[BUG] `uptime` command is not correctly executed on MacOS](https://github.com/gdegiorgio/systatus/issues/27)

- [[FEATURE] Implement `uptime` strategy for Windows](https://github.com/gdegiorgio/systatus/issues/26)
...
- [[Chore] Golang import grouping by package](https://github.com/ray-project/kuberay/issues/2567)

- [[Feature] Add e2e tests for Autoscaler V2](https://github.com/ray-project/kuberay/issues/2574)

- [[Feature] Add e2e tests for inconsistency between worker group's `replicas` and the number of Pods](https://github.com/ray-project/kuberay/issues/2575)

- [[Feature] Add an e2e test for Autoscaler to scale up by manually updating `minReplicas`](https://github.com/ray-project/kuberay/issues/2576)
...
- [Compatibility with Terraform 1.10](https://github.com/gruntwork-io/terragrunt/issues/3604)
...
## nspcc-dev/neo-go <span style='color:#F1C40F'>(124 ⭐️)</span>
...
## west2-online/fzuhelper-server <span style='color:#F1C40F'>(9 ⭐️)</span>
...
## celestiaorg/celestia-core <span style='color:#F1C40F'>(490 ⭐️)</span>
...
## eiffel-community/eiffelevents-sdk-go <span style='color:#F1C40F'>(1 ⭐️)</span>

- [Public key loading errors are hidden](https://github.com/eiffel-community/eiffelevents-sdk-go/issues/103)
...
## davidfischer-ch/terraform-provider-aria <span style='color:#F1C40F'>(4 ⭐️)</span>

- [Add `aria_orchestrator_category` resource](https://github.com/davidfischer-ch/terraform-provider-aria/issues/87)
...
## operator-framework/operator-controller <span style='color:#F1C40F'>(76 ⭐️)</span>

- [Docs: describe Brief & RFC process](https://github.com/operator-framework/operator-controller/issues/1483)


## alibaba/higress <span style='color:#F1C40F'>(3.6K ⭐️)</span>
...
## kyma-project/modulectl <span style='color:#F1C40F'>(0 ⭐️)</span>

- [Wrap errors from newest to oldest](https://github.com/kyma-project/modulectl/issues/105)

- [[Restricted Markets] Drop oci-registry-cred label creation](https://github.com/kyma-project/modulectl/issues/106)

- [[Mandatory Modules] Introduce mandatory module Label in module create](https://github.com/kyma-project/modulectl/issues/94)
...
- [Self-heal exponential backoff is not calculated properly](https://github.com/argoproj/argo-cd/issues/20976)
...
- [Document removing vm.endpoint from core.yaml](https://github.com/hyperledger-labs/fabric-builder-k8s/issues/223)

- [Description not shown for docker images](https://github.com/hyperledger-labs/fabric-builder-k8s/issues/213)


## elastic/cloud-on-k8s <span style='color:#F1C40F'>(66 ⭐️)</span>
