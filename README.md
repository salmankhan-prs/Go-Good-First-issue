...
## recursecenter/pairing-bot <span style='color:#F1C40F'>(22 ⭐️)</span>
...
## celestiaorg/go-square <span style='color:#F1C40F'>(13 ⭐️)</span>

- [porposal: introduce `Commitment` method on `share.Blob`](https://github.com/celestiaorg/go-square/issues/114)
...
## pg-sharding/spqr <span style='color:#F1C40F'>(929 ⭐️)</span>
...
- [Start/stop button hotkey](https://github.com/anfragment/zen/issues/124)
...
- [guides: fix missing label for AuthPolicy for guide](https://github.com/Kuadrant/kuadrant-operator/pull/1010)
...
## vmware-tanzu/secrets-manager <span style='color:#F1C40F'>(159 ⭐️)</span>

- [use SPIFFE helm-charts-hardened as an upstream helm chart for SPIRE.](https://github.com/vmware-tanzu/secrets-manager/issues/1215)
...
## opensearch-project/opensearch-k8s-operator <span style='color:#F1C40F'>(400 ⭐️)</span>
