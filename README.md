...
## kubernetes/kubernetes <span style='color:#F1C40F'>(110.5K ⭐️)</span>
...
## score-spec/score-k8s <span style='color:#F1C40F'>(21 ⭐️)</span>

- [[bug] `score-k8s init` create the default `score.yaml` in `0600` instead of `0755`](https://github.com/score-spec/score-k8s/issues/57)

- [[feature request] `check-version` subcommand](https://github.com/score-spec/score-k8s/issues/50)

- [[feature request] `completion` subcommand](https://github.com/score-spec/score-k8s/issues/51)


## elastic/elastic-agent <span style='color:#F1C40F'>(130 ⭐️)</span>
...
## jlewi/foyle <span style='color:#F1C40F'>(98 ⭐️)</span>
...
## kedacore/keda <span style='color:#F1C40F'>(8.4K ⭐️)</span>
...
## DiceDB/playground-mono <span style='color:#F1C40F'>(36 ⭐️)</span>

- [Add cron for cleanup of keys from DiceDB](https://github.com/DiceDB/playground-mono/issues/32)

- [Add integration tests for commands execution related to hyperloglog (3)](https://github.com/DiceDB/playground-mono/issues/30)

- [Add integration tests for commands execution (2)](https://github.com/DiceDB/playground-mono/issues/29)
...
- [`argocd app actions run` with invalid action name returns poor error message](https://github.com/argoproj/argo-cd/issues/20408)

- [ArgoCD should support `helm template --skip-tests`](https://github.com/argoproj/argo-cd/issues/19956)


## fortio/fortio <span style='color:#F1C40F'>(3.3K ⭐️)</span>

- [use flag set.Func() instead of custom type for -H, perclist etc](https://github.com/fortio/fortio/issues/993)
...
## pingcap/tiflow <span style='color:#F1C40F'>(426 ⭐️)</span>
...
## DiceDB/dice <span style='color:#F1C40F'>(6.3K ⭐️)</span>

- [Docs: Improve HTTP and Websocket documentation](https://github.com/DiceDB/dice/issues/1113)
...
- [Audit and make documentation for command `GETEX` consistent](https://github.com/DiceDB/dice/issues/821)
...
## doublecloud/transfer <span style='color:#F1C40F'>(23 ⭐️)</span>

- [Mysql/source: allow to configure flush-intervals](https://github.com/doublecloud/transfer/issues/59)

- [Kafka/sink: allow to adjust buffer for writer](https://github.com/doublecloud/transfer/issues/58)


## zitadel/zitadel <span style='color:#F1C40F'>(8.6K ⭐️)</span>

- [[Bug]: AddIDPToLoginPolicy is called twice in console](https://github.com/zitadel/zitadel/issues/8653)


## anfragment/zen <span style='color:#F1C40F'>(2.3K ⭐️)</span>

- [contenttype modifier doesn't match Content-Type headers with parameters](https://github.com/anfragment/zen/issues/118)
