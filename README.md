...
- [Handle Q.WATCH updates in a single event loop for Websockets](https://github.com/DiceDB/dice/issues/1153)
...
## celestiaorg/go-header <span style='color:#F1C40F'>(19 ⭐️)</span>

- [p2p: peerTracker.gc leaks time.Ticker due to missing defer ticker.Stop(); please integrate leak static analyzer](https://github.com/celestiaorg/go-header/issues/223)
...
## gomods/athens <span style='color:#F1C40F'>(4.4K ⭐️)</span>

- [Switch to ListObjectsV2](https://github.com/gomods/athens/issues/1991)
...
## mindersec/minder <span style='color:#F1C40F'>(258 ⭐️)</span>
...
## gittuf/gittuf <span style='color:#F1C40F'>(457 ⭐️)</span>
...
## ethereum-optimism/monitorism <span style='color:#F1C40F'>(20 ⭐️)</span>

- [Feature: mTLS support for the `psp_executor` HTTP API into `op-defender`](https://github.com/ethereum-optimism/monitorism/issues/77)
...
## databricks/cli <span style='color:#F1C40F'>(139 ⭐️)</span>
