...
- [Add timing info to container state UI](https://github.com/argoproj/argo-cd/issues/20913)
...
## spiffe/spike <span style='color:#F1C40F'>(23 ⭐️)</span>
...
## lima-vm/lima <span style='color:#F1C40F'>(15.5K ⭐️)</span>

- [https://lima-vm.io/community/ should just redirect to https://lima-vm.io/docs/community/](https://github.com/lima-vm/lima/issues/2927)
