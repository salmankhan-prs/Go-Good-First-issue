...
## kubernetes/minikube <span style='color:#F1C40F'>(29.4K ⭐️)</span>

- [Installing step should have docker user and group creation step as well](https://github.com/kubernetes/minikube/issues/19742)


## temporalio/terraform-provider-temporalcloud <span style='color:#F1C40F'>(11 ⭐️)</span>

- [[Feature Request] Document or Blog for Import Guidance](https://github.com/temporalio/terraform-provider-temporalcloud/issues/151)
...
## NibiruChain/nibiru <span style='color:#F1C40F'>(185 ⭐️)</span>
...
## kashifkhan0771/utils <span style='color:#F1C40F'>(3 ⭐️)</span>

- [[FEATURE] random package (rand)](https://github.com/kashifkhan0771/utils/issues/28)
...
- [Allow dependabot PRs to deploy to vercel](https://github.com/omni-network/omni/issues/2312)
...
## polymerdao/monomer <span style='color:#F1C40F'>(21 ⭐️)</span>
...
## mariadb-operator/mariadb-operator <span style='color:#F1C40F'>(487 ⭐️)</span>
...
## CSE-25/amrita_pyq <span style='color:#F1C40F'>(1 ⭐️)</span>

- [Add CODE_OF_CONDUCT](https://github.com/CSE-25/amrita_pyq/issues/9)

- [Add Security Policy](https://github.com/CSE-25/amrita_pyq/issues/10)

- [Remove unused line or make it useful.](https://github.com/CSE-25/amrita_pyq/issues/6)

- [Add Bubbles for Courses.](https://github.com/CSE-25/amrita_pyq/issues/5)

- [Add `DOCUMENTATION` on how to use this tool.](https://github.com/CSE-25/amrita_pyq/issues/3)
