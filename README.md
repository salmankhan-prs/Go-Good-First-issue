...
## zitadel/zitadel <span style='color:#F1C40F'>(8.7K ⭐️)</span>
...
- [Weird get Qualification with unassiged lane](https://github.com/NYCUarchery/archeryWebsite/issues/176)

- [在有比賽清單的地方加上user自己的在比賽中的身分提示](https://github.com/NYCUarchery/archeryWebsite/issues/172)

- [Player 附帶instition name](https://github.com/NYCUarchery/archeryWebsite/issues/183)

- [user real name cannot be empty ](https://github.com/NYCUarchery/archeryWebsite/issues/167)

- [應該要有按鈕可以返回主頁](https://github.com/NYCUarchery/archeryWebsite/issues/173)

- [訪客的recent competition根本不會load](https://github.com/NYCUarchery/archeryWebsite/issues/182)
...
- [Configure Loadbalancer back-end pool only for controlplane machines](https://github.com/kubernetes-sigs/cluster-api-provider-ibmcloud/issues/1990)


## ppc64le-cloud/pvsadm <span style='color:#F1C40F'>(37 ⭐️)</span>

- [Enhancement: Display upload size in a more simplified manner along with an upload progress bar.](https://github.com/ppc64le-cloud/pvsadm/issues/682)

- [Enhancement: Check if a condition is met before the polling interval has elapsed.](https://github.com/ppc64le-cloud/pvsadm/issues/676)

- [Enhancement: Integrate a spinner to track time taken for long running operations.](https://github.com/ppc64le-cloud/pvsadm/issues/679)
...
## aquasecurity/trivy <span style='color:#F1C40F'>(23.3K ⭐️)</span>
