...
## kubernetes-sigs/cluster-api-provider-azure <span style='color:#F1C40F'>(295 ⭐️)</span>
...
## BountySecurity/gbounty <span style='color:#F1C40F'>(60 ⭐️)</span>

- [Add support to determine custom variables](https://github.com/BountySecurity/gbounty/issues/11)
...
## kubestellar/kubestellar <span style='color:#F1C40F'>(277 ⭐️)</span>
...
- [chore: improve error logs in server/cluster/cluser.go](https://github.com/argoproj/argo-cd/issues/20710)
...
## pg-sharding/spqr <span style='color:#F1C40F'>(930 ⭐️)</span>
...
## bacalhau-project/bacalhau <span style='color:#F1C40F'>(701 ⭐️)</span>
