...
- [docs: update or replace Coder Tour](https://github.com/coder/coder/issues/15088)

- [Notifications: improve wording](https://github.com/coder/coder/issues/14893)


## gittuf/gittuf <span style='color:#F1C40F'>(454 ⭐️)</span>
...
## TibiaData/tibiadata-api-go <span style='color:#F1C40F'>(82 ⭐️)</span>

- [Add 'Link' Field to Information in API Responses (Fixes #381)](https://github.com/TibiaData/tibiadata-api-go/pull/398)
...
## Foxboron/sbctl <span style='color:#F1C40F'>(1.5K ⭐️)</span>

- [Unable to enroll-keys using TPM2 EventLog](https://github.com/Foxboron/sbctl/issues/384)
...
## cnoe-io/idpbuilder <span style='color:#F1C40F'>(180 ⭐️)</span>
...
## Project-HAMi/HAMi <span style='color:#F1C40F'>(768 ⭐️)</span>
