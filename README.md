...
- [Create JSONata processor](https://github.com/warpstreamlabs/bento/issues/165)
...
## scribble-rs/scribble.rs <span style='color:#F1C40F'>(438 ⭐️)</span>
...
- [Add documentation for command `TYPE`](https://github.com/DiceDB/dice/issues/1280)
...
## gofr-dev/gofr <span style='color:#F1C40F'>(3.6K ⭐️)</span>

- [how to return custom http response data and header ](https://github.com/gofr-dev/gofr/issues/1130)
...
## mintoolkit/mint <span style='color:#F1C40F'>(175 ⭐️)</span>
...
## alibaba/higress <span style='color:#F1C40F'>(3.3K ⭐️)</span>
...
## pingcap/tiflow <span style='color:#F1C40F'>(429 ⭐️)</span>

- [metadata error with MariaDB 11.4](https://github.com/pingcap/tiflow/issues/11735)
...
- [Documentation broken link: https://fediverse.town/](https://github.com/owncast/owncast/issues/4017)
