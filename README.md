...
## jesusprubio/up <span style='color:#F1C40F'>(406 ⭐️)</span>

- [Grepable output](https://github.com/jesusprubio/up/issues/57)
...
## argoproj-labs/argocd-agent <span style='color:#F1C40F'>(74 ⭐️)</span>
...
## uyuni-project/uyuni-tools <span style='color:#F1C40F'>(16 ⭐️)</span>

- [Command to cleanup SSH known hosts](https://github.com/uyuni-project/uyuni-tools/issues/501)
...
## wesql/wescale <span style='color:#F1C40F'>(209 ⭐️)</span>
